 ...
 *
 * EC-specific display functions extracted from display-components.js and
 * ec-demo.js. Keeps ec-demo.js as a thin event-handler controller.
 *
 * DEPENDENCIES: DisplayComponents, UIUtils, MathUtils, Config
 * ============================================================================
 */
...
const ECDisplay = {
    ...
    // Security alert for weak ECC parameters
     ...
     */
    displayPointOperationResult(operation, P, Q, result, notation) {
        let html = `
        <div class="card card--result">
            <h3>✓ ${operation}</h3>
     ...
     */
    displayECDHResults(curve, alice, bob, aliceSecret, bobSecret, aliceKey, bobKey) {
     ...
     */
    displayECDSAVerifyResults(verifyMessage, originalMessage, signature, isValid) {
